...
{{csrf_field()}}
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input id="model" class="form-control col-md-12 col-xs-12" name="model" placeholder="Exemple : RS6" required="required" type="text" value="{{old('model',$cars->model)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='brand' id='brand' class='form-control' placeholder="Exemple : Audi" type="text" value="{{old('brand',$cars->brand)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='power' id='power' class='form-control' placeholder="Exemple : 600 CH" type="text" value="{{old('power',$cars->power)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='year' id='year' class='form-control' placeholder="Exemple : 2022" type="text" value="{{old('year',$cars->year)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='finishing' id='finishing' class='form-control' placeholder="Exemple : S Line" type="text" value="{{old('finishing',$cars->finishing)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <textarea name='short_description' id='short_description' class='form-control'>{{old('short_description',$cars->short_description)}}</textarea>
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='main_photo' id='main_photo' class='form-control' placeholder="URL" type="text" value="{{old('main_photo',$cars->main_photo)}}">
       ...
       <div class="form-group">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <input name='sale_price' id='sale_price' class='form-control' type="text" value="{{old('sale_price',$cars->sale_price)}}">
